...
from cassandra.cqlengine.columns import UUID, Text, DateTime, Float, Date, Integer, Boolean, List
...
class Game(Model):
	...
	home_players = List(value_type=Integer)
	away_players = List(value_type=Integer)
